...
// PausableUtilMetaData contains all meta data concerning the PausableUtil contract.
var PausableUtilMetaData = &bind.MetaData{
...
// Deprecated: Use PausableUtilMetaData.ABI instead.
var PausableUtilABI = PausableUtilMetaData.ABI
