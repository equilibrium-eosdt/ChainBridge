...
type Events struct {
	...
	GensOptOut_Sold								   []equilibrium.EventGensOptOutSold
	GensOptOut_Bought							   []equilibrium.EventGensOptOutBought
	GensOptOut_Distributed						   []equilibrium.EventGensOptOutDistributed
