...
именовать их по-разному. Например, chainbridge0, chainbridge1, ,,,
chainbridge99. Сервис этот падучий, придётся постоянно мониторить и
перезапускать.  Полезно будет поддерживать реестр актуальных
конфигураций. Возможно, придётся разработать сервис мониторинга и
